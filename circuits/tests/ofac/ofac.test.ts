...
import nameAndDobjson from '@selfxyz/common/constants/ofac/nameAndDobSMT.json' with { type: 'json' };
import nameAndYobjson from '@selfxyz/common/constants/ofac/nameAndYobSMT.json' with { type: 'json' };
import nameAndDobIdCardJson from '@selfxyz/common/constants/ofac/nameAndDobSMT_ID.json' with { type: 'json' };
import nameAndYobIdCardJson from '@selfxyz/common/constants/ofac/nameAndYobSMT_ID.json' with { type: 'json' };
import { genMockIdDoc } from '@selfxyz/common/utils/passports/genMockIdDoc';
import passportNoAndNationalityjson from '@selfxyz/common/constants/ofac/passportNoAndNationalitySMT.json' with { type: 'json' };
