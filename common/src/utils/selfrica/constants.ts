...
export const SELFRICA_PUBLIC_SIGNALS_FORBIDDEN_COUNTRIES_PACKED = 9;
export const SELFRICA_PUBLIC_SIGNALS_FORBIDDEN_COUNTRIES_PACKED_LENGTH = 4;

export const SELFRICA_PUBLIC_SIGNALS_IDENTITY_COMMITMENT = 13;
export const SELFRICA_PUBLIC_SIGNALS_NULLIFIER = 14;
export const SELFRICA_PUBLIC_SIGNALS_PUBKEY_X = 15;
export const SELFRICA_PUBLIC_SIGNALS_PUBKEY_Y = 16;
export const SELFRICA_PUBLIC_SIGNALS_SCOPE = 17;
export const SELFRICA_PUBLIC_SIGNALS_OFAC_NAME_DOB_SMT_ROOT = 18;
export const SELFRICA_PUBLIC_SIGNALS_OFAC_NAME_YOB_SMT_ROOT = 19;
export const SELFRICA_PUBLIC_SIGNALS_ATTESTATION_ID = 20;
export const SELFRICA_PUBLIC_SIGNALS_USER_IDENTIFIER = 21;
export const SELFRICA_PUBLIC_SIGNALS_CURRENT_DATE = 22;
