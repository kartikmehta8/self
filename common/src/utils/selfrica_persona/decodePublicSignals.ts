...
import { SelfricaDisclosePublicInput } from "./types.js";
...
export const decodePublicSignals = (publicSignals: string[]) => {
    ...
    const userIdentifier = publicSignals[SELFRICA_PUBLIC_SIGNALS_USER_IDENTIFIER];

    const selfricaDisclosePublicInput: SelfricaDisclosePublicInput = {
    ...
    return selfricaDisclosePublicInput;
}
