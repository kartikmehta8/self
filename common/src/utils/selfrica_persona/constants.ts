...
export const SELFRICA_PUBLIC_SIGNALS_NULLIFIER = 14;

export const SELFRICA_PUBLIC_SIGNALS_SCOPE = 15;
export const SELFRICA_PUBLIC_SIGNALS_USER_IDENTIFIER = 16;

export const SELFRICA_PUBLIC_SIGNALS_CURRENT_DATE = 17;
export const SELFRICA_PUBLIC_SIGNALS_CURRENT_DATE_LENGTH = 8;

export const SELFRICA_PUBLIC_SIGNALS_OFAC_NAME_DOB_SMT_ROOT = 25;
export const SELFRICA_PUBLIC_SIGNALS_OFAC_NAME_YOB_SMT_ROOT = 26;
